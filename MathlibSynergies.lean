-- This module serves as the root of the `MathlibSynergies` library.
-- Import modules here that should be built as part of the library.
import «MathlibSynergies».Basic
import «MathlibSynergies».CommonPitfalls
import «MathlibSynergies».InductionExamples
